...
<section class="container login-form">
	...
	<div class="form-group">
					...
					<input type="text" name="username" required class="form-control" placeholder="Nazwa użytkownika" />
				...
				<div class="alert-danger">Nieprawidłowa nazwa użytkownika lub hasło.</div>
			</c:if>
